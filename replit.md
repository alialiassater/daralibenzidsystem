...
- **خصائص الورق**: حجم الورق (16/24، 15/22، A3، A4، A5) ونوع الورق (اكسترا، اوتوكولون، انسيار، أخرى)
- **تعديل المواد**: للمدير فقط - تعديل السعر وخصائص الورق بدون حذف
...
- **ربط الباركود بـ ISBN**: الباركود يعتمد مباشرة على رقم ISBN ولا يتم توليده عشوائياً.
- **تعديل الكتب الكامل**: (الاسم، المؤلف، ISBN، الصنف، الكميات، السعر) مع التحقق من تفرد ISBN وتحديث الباركود تلقائياً.
...
- البحث والتصفية حسب الصنف والباركود/ISBN
- **طباعة الباركود**: إمكانية عرض وطباعة باركود ISBN لكل كتاب.
...
- `PATCH /api/materials/:id` - تعديل المادة (السعر، حجم الورق، نوع الورق) - للمدير فقط
...
- 2026-01-23: ربط باركود الكتب برقم ISBN وتوفير ميزة مسح ISBN للبحث عن الكتب وطباعة الباركود.
- 2026-01-23: إضافة خصائص الورق (حجم الورق ونوعه) وإمكانية تعديل السعر والخصائص للمدير فقط، إزالة نظام الحد الأدنى للمخزون.
